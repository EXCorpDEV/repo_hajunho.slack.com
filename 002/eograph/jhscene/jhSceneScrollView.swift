...
open class jhSceneScrollView : UIScrollView {
...
//
    ...
    fileprivate func extractedFunc(_ currentPoint: CGPoint) {
        ...
        //            self.scenePanPoint = piece.center
        //        }
        //        // Update the position for the .began, .changed, and .ended states
        //        if gestureRecognizer.state != .cancelled {
        //            // Add the X and Y translation to the view's original position.
        //
        //            // be able to separate from the view attached.
        //            let newCenter = CGPoint(x: scenePanPoint.x + translation.x, y: scenePanPoint.y + translation.y)
        ////            piece.center = newCenter
        //        }
        //        else {
        //            // On cancellation, return the piece to its original location.
        //            piece.center = scenePanPoint
        //        }
        guideLine.removeFromSuperlayer()
        guideLine = jhGuideLine(x: currentPoint.x , y: 0, lineWidth: 1, layer: 0)!
...
//        extractedFunc(CGPoint(x: zoomedRect.width, y: zoomedRect.height))
        self.jhSceneFrameWidth = zoomedRect.width
        self.jhSceneFrameHeight = zoomedRect.height
