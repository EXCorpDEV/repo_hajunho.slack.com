...
open class ImageScrollView: UIScrollView {
    ...
    private func initialize() {
        ...
        //ERROR            UIScrollView.DecelerationRate.fast
        delegate = self
        
        //ERROR        NotificationCenter.default.addObserver(self, selector: #selector(ImageScrollView.changeOrientationNotification), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
