...
class jhDrawAxisLayer<T> : CALayer {
    ...
    init(_ x: jhPanel<T>, layer: Any, panelID: Int, hGuide: Bool, countVaxis: Int, maxY: CGFloat) {
        ...
        self.mMargin = GS.s.jhAMarginCommonV
...
//            self.addSublayer(drawText(str: String(x), x: xlocation-GS.s.jhATextPanelSize, y: jhDraw.ARQ-mMargin, width: GS.s.jhATextPanelSize, height: GS.s.jhATextPanelSize))
        }
...
//                self.addSublayer(drawText(str: label, x: 100, y: fx2 - 600, width: GS.s.jhATextPanelSize, height: GS.s.jhATextPanelSize))
